...
namespace WindowsFormsKursach2
{
    public partial class Form5 : Form
    {
        public Form5()
        {
            ...
            // Строка запроса
            string select = "SELECT ID_Visitors, FullName FROM Visitors";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string PhoneNumb = textBox2.Text;
            ...
            string insert = "INSERT INTO Visitors (FullName, PhoneNumb, Member_ID) VALUES ('" + FullName + "','" + PhoneNumb + "'," + Member_ID + ")";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            long ivis = Convert.ToInt64(comboBox1.SelectedValue);

            // Строка запроса
            // удаляем запись с выбранным идентификатором
            string delete = "DELETE FROM Visitors WHERE ID_Visitors = " + ivis;
