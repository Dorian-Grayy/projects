...
namespace WindowsFormsKursach2
{
    public partial class Form4 : Form
    {
        public Form4()
        {
            ...
            // Строка запроса
            string select = "SELECT ID_Training, Name FROM Training";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string Trainers_ID = textBox5.Text;

            // Если, например, поле Man числовое, нужно из конструкции убрать
            // лишние одинарные кавычки (поле не текстовое), записать так:
            string insert = "INSERT INTO Training (Name, Category, Day, Time, Trainers_ID) VALUES ('" + Name + "','" + Category + "','" + Day + "','" + Time + "'," + Trainers_ID + ")";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            long itrg = Convert.ToInt64(comboBox1.SelectedValue);

            // Строка запроса
            // удаляем запись с выбранным идентификатором
            string delete = "DELETE FROM Training WHERE ID_Training = " + itrg;
