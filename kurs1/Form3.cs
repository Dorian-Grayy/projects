...
namespace WindowsFormsKursach2
{
    public partial class Form3 : Form
    {
        public Form3()
        {
            ...
            // Строка запроса
            string select = "SELECT ID_Trainers, FullName FROM Trainers";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string select = "SELECT * FROM Trainers";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string insert = "INSERT INTO Trainers (FullName, Position, Salary, PhoneNumb) VALUES ('" + FullName + "','" + Position +"'," + Salary + ",'"+ PhoneNumb + "')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            long itr = Convert.ToInt64(comboBox1.SelectedValue);

            // Строка запроса
            // удаляем запись с выбранным идентификатором
            string delete = "DELETE FROM Trainers WHERE ID_Trainers = " + itr;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < dataGridView1.RowCount; i++)
            {
                ...
                try
                {
                    ...
                    connection.Open();
                    SqlDataAdapter adapter = new SqlDataAdapter(select, connection);
                    SqlCommandBuilder commandDuilder = new SqlCommandBuilder(adapter);
                    DataTable dt = new DataTable();
                    adapter.Update(dt); // Обновляем таблицу
